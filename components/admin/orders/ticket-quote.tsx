...
export function TicketQuote({ order }: QuoteProps) {
    ...
    try {
      ...
      await supabase
        ...
        .insert({
          request_id: order.id,
          action: 'quote_sent',
          description: `Ticket Quote generated and sent for $${total.toFixed(2)}`,
          is_internal: false
        })
  ...
  return (
    <div className="brutal-card bg-[#FCE7F3] p-6 mb-8 border-4 border-black shadow-[8px_8px_0px_var(--color-foreground)]">
      <div className="flex items-center gap-3 mb-6 pb-4 border-b-4 border-black">
        ...
        <div>
          ...
          <p className="text-[10px] font-bold uppercase tracking-widest opacity-80">Ticket Booking Module</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmitQuote} className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest opacity-80">Ticket Base Price</label>
            <div className="flex">
